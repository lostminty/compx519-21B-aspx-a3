...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2020 at 06:06 AM
...
INSERT INTO `reviews` (`name`, `review`, `productCode`) VALUES
('Trex', '	Good model', 'S10_1949'),
('troll', 'Bad product	', 'S18_4933'),
('vimal', 'A comment	', 'S10_2016'),
('Jello', 'Sweet', 'S10_2016'),
('Trex', 'I liked the kickstand in this model very much', 'S10_1678'),
('Weka', 'Perfect! I was looking for this.', 'S10_4757'),
('flyinghigh', 'Nice!', 'S18_1662'),
('h@ck0r', 'Can do sqli?', 'S18_3029'),
('random', 'what is sqli?', 'S18_3029'),
('boatee', 'perfect carving. Loved it!', 'S24_2011');
